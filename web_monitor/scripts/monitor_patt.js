...
patt_2l.subscribe(function(message) {
    document.getElementById("patt_2l").innerHTML = (message.data).toFixed(1);
});

patt_2r.subscribe(function(message) {
    document.getElementById("patt_2r").innerHTML = (message.data).toFixed(1);
});

patt_3l.subscribe(function(message) {
    document.getElementById("patt_3l").innerHTML = (message.data).toFixed(1);
});

patt_3r.subscribe(function(message) {
    document.getElementById("patt_3r").innerHTML = (message.data).toFixed(1);
});

patt_4l.subscribe(function(message) {
    document.getElementById("patt_4l").innerHTML = (message.data).toFixed(1);
});

patt_4r.subscribe(function(message) {
    document.getElementById("patt_4r").innerHTML = (message.data).toFixed(1);
});

patt_5l.subscribe(function(message) {
    document.getElementById("patt_5l").innerHTML = (message.data).toFixed(1);
});

patt_5r.subscribe(function(message) {
    document.getElementById("patt_5r").innerHTML = (message.data).toFixed(1);
});

patt_1rl.subscribe(function(message) {
    document.getElementById("patt_1rl").innerHTML = (message.data).toFixed(1);
});

patt_1ru.subscribe(function(message) {
    document.getElementById("patt_1ru").innerHTML = (message.data).toFixed(1);
});

patt_1ll.subscribe(function(message) {
    document.getElementById("patt_1ll").innerHTML = (message.data).toFixed(1);
});

patt_1lu.subscribe(function(message) {
    document.getElementById("patt_1lu").innerHTML = (message.data).toFixed(1);
})
